    ...
    <Layout>
      ...
      <article className="resource">
        ...
        <ul>
          <li>
            Bible.is:&nbsp;
            <a href="http://www.bible.is/" target="_blank">
              Website
            </a>
          </li>
          <li>
      ...
      <article className="resource">
        ...
        <ul>
          <li>
            Nicholson1968:&nbsp;
            <a href="https://www.nicholson1968.com/" target="_blank">
              Website
            </a>
            &nbsp;|&nbsp;
            <a
      ...
      <article className="resource">
        ...
        <ul>
          <li>
            Destiny Lab:&nbsp;
            <a href="https://www.destinylab.com/" target="_blank">
              Website
            </a>
            &nbsp;|&nbsp;
            <a href="https://www.youtube.com/user/destinylab" target="_blank">
              YouTube
            </a>
          </li>
          <li>
